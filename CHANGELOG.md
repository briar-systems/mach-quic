...
- A size guard pins what an idle connection costs (#137): `assembly.Storage` at 5,488 bytes and `Connection` at 9,136, no chunks held by an established idle connection, and one record chunk once the six H3 control streams are open and drained.
